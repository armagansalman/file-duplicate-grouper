...
def main_1(args):
    # (
    dirs: t_List[t_Path] = [
        PathData("/home/genel/Desktop/TEMP/"), PathData("/home/genel/Videos/")]
    #
    x = PathData("abc")
    ...
    for idx, data in enumerate(fdatas):
        ...
        print(
            f"File ({idx}) size == {sz/(1024**2):.2} Mb , {sz/(1024):.2} Kb , {sz} bytes.")
        print()
    # )
    exit()
# )
...
def main_2(args):
    # (
    dirs_1 = ["/media/genel/SAMSUNG/NOT SAMS/Personal/", "/media/genel/SAMSUNG/NOT SAMS/Aile fotolar, videolar/", "/media/genel/SAMSUNG/NOT SAMS/Movies-Series/",
              "/media/genel/SAMSUNG/NOT SAMS/ALL BOOKS-PAPERS/", "/media/genel/SAMSUNG/NOT SAMS/ESSENTIAL BACKUP/", "/media/genel/SAMSUNG/NOT SAMS/BACKUP-HP-2022-05-06/"]
    #
    dirs_5 = dirs_1
